        ...
        <div class="card">
            ...
            <div class="card-body">
                <table id="dataKategori" class="table table-bordered">
                    ...
                    <tbody>
                        @foreach ($dataProduct as $k)
                        <tr>
                            <td>{{ $loop->iteration }}</td>
                            <td class="text-center"><img src="{{ asset('/uploads/products/'. $k->image) }}" alt="" width="100px;"> </td>
                            <td class="text-center">{{ $k->namaProduct }}</td>
                            <td class="text-center">{{ $k->harga }}</td>
                            <td class="text-center">{{ $k->nameUsers }}</td>
